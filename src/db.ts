  ...
  const defaultServices = [
    {
      ...
      description: "Comprehensive health and safety training for your workplace.",
      icon: "ShieldAlert",
      images: JSON.stringify(["https://picsum.photos/seed/hs1/800/600", "https://picsum.photos/seed/hs2/800/600"]),
      videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4",
      howItWorks: JSON.stringify(["Initial Assessment", "Customized Training Plan", "On-site Execution", "Certification"]),
      checklistOptions: JSON.stringify(["First Aid", "Fire Safety", "Manual Handling", "Risk Assessment"]),
      benefits: JSON.stringify([{ title: "Compliance", description: "Stay compliant with local laws." }, { title: "Safety", description: "Reduce workplace accidents." }]),
      modules: JSON.stringify([{ title: "Basics", text: "Introduction to safety." }, { title: "Advanced", text: "Deep dive into protocols." }]),
      accreditation: "ISO 45001 Certified",
      whatsappNumber: "+44123456789"
    },
    {
      title: "Tractor Training",
      description: "Professional tractor operation and maintenance training.",
      icon: "Tractor",
      images: JSON.stringify(["https://picsum.photos/seed/tr1/800/600", "https://picsum.photos/seed/tr2/800/600"]),
      videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4",
      howItWorks: JSON.stringify(["Theory Class", "Practical Demonstration", "Supervised Practice", "Final Test"]),
      checklistOptions: JSON.stringify(["Basic Operation", "Advanced Maneuvers", "Maintenance", "Attachment Handling"]),
      benefits: JSON.stringify([{ title: "Efficiency", description: "Operate machinery faster." }]),
      modules: JSON.stringify([{ title: "Maintenance", text: "Keep your tractor running." }]),
      accreditation: "Lantra Awards",
      whatsappNumber: "+44123456789"
    },
    {
      title: "Forklift Operation",
      description: "Certified forklift operation training for warehouse safety.",
      icon: "Forklift",
      images: JSON.stringify(["https://picsum.photos/seed/fl1/800/600", "https://picsum.photos/seed/fl2/800/600"]),
      videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4",
      howItWorks: JSON.stringify(["Safety Briefing", "Controls Familiarization", "Load Handling", "Certification"]),
      checklistOptions: JSON.stringify(["Counterbalance", "Reach Truck", "Pallet Truck", "Rough Terrain"]),
      benefits: JSON.stringify([{ title: "Skill", description: "Master load handling." }]),
      modules: JSON.stringify([{ title: "Safety", text: "Avoid tip-overs." }]),
      accreditation: "RTITB Accredited",
      whatsappNumber: "+44123456789"
    },
    {
      title: "Working at Heights",
      description: "Essential training for safe working at elevated positions.",
      icon: "Mountain",
      images: JSON.stringify(["https://picsum.photos/seed/wh1/800/600", "https://picsum.photos/seed/wh2/800/600"]),
      videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4",
      howItWorks: JSON.stringify(["Equipment Inspection", "Harness Usage", "Fall Arrest Systems", "Rescue Procedures"]),
      checklistOptions: JSON.stringify(["Scaffolding", "Ladders", "MEWPs", "Rope Access"]),
      benefits: JSON.stringify([{ title: "Rescue", description: "Learn rescue protocols." }]),
      modules: JSON.stringify([{ title: "Equipment", text: "Harnesses and lanyards." }]),
      accreditation: "IPAF Certified",
      whatsappNumber: "+44123456789"
    },
    {
      title: "First Aid at Work",
      description: "Emergency first aid training for designated workplace responders.",
      icon: "HeartPulse",
      images: JSON.stringify(["https://picsum.photos/seed/fa1/800/600", "https://picsum.photos/seed/fa2/800/600"]),
      videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4",
      howItWorks: JSON.stringify(["CPR Training", "Wound Care", "Medical Emergencies", "Practical Scenarios"]),
      checklistOptions: JSON.stringify(["Basic Life Support", "AED Usage", "Pediatric First Aid", "Sports First Aid"]),
      benefits: JSON.stringify([{ title: "Life Saving", description: "Be ready for emergencies." }]),
      modules: JSON.stringify([{ title: "CPR", text: "Chest compressions." }]),
      accreditation: "Red Cross Approved",
      whatsappNumber: "+44123456789"
    }
  ];
